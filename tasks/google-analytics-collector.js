...
function downloadFiles(startDate = '2011-06-10', endDate = 'yesterday', callback) {
  ...
  const url = `https://www.googleapis.com/analytics/v3/data/ga?ids=ga%3A58359416&start-date=${startDate}&end-date=${endDate}&metrics=ga%3AbounceRate%2Cga%3Apageviews%2Cga%3AavgTimeOnPage&dimensions=ga%3ApagePath&sort=-ga%3Apageviews&access_token=`;
