...
updated: 2014-10-03 06:59:34 -0400
comments: true
...
If you have data in MongoDB you see them listed in the main page. If you not you can follow the steps in [here](http://adrianmejia.com/blog/2014/10/01/creating-a-restful-api-tutorial-with-nodejs-and-mongodb/#browser-and-postman) to get some in.
...
```html Change the ID link in the "/todos.html" template
...
```diff Delete functionality (diff)
